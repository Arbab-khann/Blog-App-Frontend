    ...
    <>
      ...
      <div className="main-block">
        <div className="data-main-bock">
          ...
          <hr className="hr-top" />
          {data
            .filter((data) => data.categories === "Fitness")
            .map((item, index) => {
              return (
                <>
        ...
        <div className="story-block">
          ...
          <hr className="hr-top" />
          {data
            .filter((data) => data.story === "fitnesstop")
            .map((item, index) => {
              return (
                <>
          ...
          <div className="data-main-bock belowtop-main">
            {data
              .filter((data) => data.story === "fitnessbelowtop")
              .map((item, index) => {
                return (
                  <>
                    <div className="beloptop-main">
          ...
          <div className="ad">
            {data
              .filter((data) => data.type === "fitness-ad")
              .map((item, index) => {
                return (
                  <>
